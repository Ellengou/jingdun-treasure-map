...
import com.jd.utils.ip.entry.IPEntry;
import com.jd.utils.ip.entry.Message;
import org.apache.log4j.Level;

import com.jd.utils.ip.entry.IPLocation;
...
public class IPSeeker {
    ...
    public IPSeeker(){
        ...
        String path = classLoader.getResource("config").getFile();
        init("QQWry.Dat", path);
    }
    ...
    public static IPSeeker getIPSeeker() {
        return IPSeekerInternal.ipseeker;
    }

    private static class IPSeekerInternal {

        static IPSeeker ipseeker = new IPSeeker();
    }
}
