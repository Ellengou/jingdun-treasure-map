...
public class FileUploadUtil {
            ...
            while (iter.hasNext()) {
                ...
                if (!item.isFormField()) {
                    ...
                    if (result) {
                        ...
                        String ext = "."+FileUtil.getExtFilename(name);
                        try {
                            //保存上传的文件到指定的目录
                            ...
                            else
                            {
                                ...
                                FileUtil.createDir(uploadfilename,true);
     ...
     * @return
     */
    public static HttpServletResponse download(File file, String fileName, HttpServletResponse response) {
        try {
